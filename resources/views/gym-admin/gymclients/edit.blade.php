                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title tabbable-line">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li>
                                                <a href="#tab_1_2" class="hidden-xs hidden-sm" data-toggle="tab">Change Avatar</a>
                                            </li>
                                            <li class="hidden-xs">
                                                ...
                                                <input type="hidden" name="type" value="general">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input readonly class="form-control form-control-inline input-medium date-picker" placeholder="Date of Birth" size="16" type="text" @if(count($client) > 0 && isset($client->dob)) value="{{ $client->dob->format('m/d/Y') }}" @endif id="dob" name="dob" />
                                                            <span class="help-block"></span>
                                                        </div>
                                                        <div class="col-md-6 form-group" id="anniversaryDiv">
                                                            <label>Anniversary</label>

                                                            <input readonly class="form-control form-control-inline input-medium date-picker" placeholder="Anniversary" size="16" type="text" value="@if(!is_null($client->anniversary)){{Carbon\Carbon::createFromFormat('Y-m-d', $client->anniversary)->format('m/d/Y')}}@endif" id="anniversary" name="anniversary" />
                                                            <span class="help-block"></span>
                                                        </div>
