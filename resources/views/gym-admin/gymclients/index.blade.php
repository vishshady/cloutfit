                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <a href="{{route('gym-admin.client.import') }}" class="btn sbold dark hidden-xs hidden-sm">
                                                <i class="fa fa-upload"></i> Import Customers</a>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" style="width: 100%" id="gym_clients">
                                <thead>
                                <tr>
