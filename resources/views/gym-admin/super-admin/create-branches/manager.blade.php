                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="first_name" @if(count($managerData) > 0 && isset($managerData->first_name)) value="{{ $managerData->first_name }}" @endif>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="last_name" id="last_name" @if(count($managerData) > 0 && isset($managerData->last_name)) value="{{ $managerData->last_name }}" @endif>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="email" id="email" @if(count($managerData) > 0 && isset($managerData->email)) value="{{ $managerData->email }}" @endif>
                                            ...
                                            <div class="md-radio-inline">
                                                <div class="md-radio">
                                                    <input type="radio" id="male" name="gender" value="male"
                                                           class="md-radiobtn" @if(count($managerData) > 0 && ($managerData->gender == 'male')) checked @endif>
                                                    <label for="male">
                                                        <span></span>
                                                ...
                                                <div class="md-radio">
                                                    <input type="radio" id="female" name="gender" value="female"
                                                           class="md-radiobtn" @if(count($managerData) > 0 && ($managerData->gender == 'female')) checked @endif>
                                                    <label for="female">
                                                        <span></span>
                                                        <span class="check"></span>
                                    ...
                                    <div class="form-group form-md-line-input mobile">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="tel" class="form-control" id="mobile" name="mobile" @if(count($managerData) > 0 && isset($managerData->mobile)) value="{{ $managerData->mobile }}" @endif>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input readonly name="date_of_birth" id="date_of_birth" type="text"
                                                   class="form-control  date-picker" data-date-format="yyyy-mm-dd" @if(count($managerData) > 0 && isset($managerData->date_of_birth)) value="{{ $managerData->date_of_birth }}" @endif>
                                    ...
                                    <div class="form-group form-md-line-input ">
                                        ...
                                        <div class="col-md-6 input-icon right">
                                            <input type="text" class="form-control" name="username" @if(count($managerData) > 0 && isset($managerData->username)) value="{{ $managerData->username }}" @endif>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail"
                                                    ...
                                                    @if(count($managerData) > 0 && $managerData->image == '')
