                ...
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body form">
                            ...
                            @if(count($client) > 0 && isset($client->id))
                            ...
                            <div class="form-wizard">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-11">
                                            <div class="form-group form-md-line-input">
                                                <input type="text" class="form-control" id="first_name"
                                                       name="first_name" @if(count($client) > 0 && isset($client->first_name)) value="{{ $client->first_name }}" @endif>
                                            ...
                                            <div class="form-group form-md-line-input ">
                                                <input type="text" class="form-control" id="last_name" name="last_name" @if(count($client) > 0 && isset($client->last_name)) value="{{ $client->last_name }}" @endif>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <select class="bs-select form-control" data-live-search="true"
                                                    ...
                                                    <option @if(count($client) > 0 && $client->gender == 'male') selected @endif value="male">Male</option>
                                                    <option @if(count($client) > 0 && $client->gender == 'female') selected @endif value="female">Female</option>
                                                </select>
                                            ...
                                            <div class="form-group form-md-radios">
                                                ...
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input type="radio" value="yes" id="yes_radio" @if(count($client) > 0 && $client->marital_status == 'yes') checked @endif
                                                    ...
                                                    <div class="md-radio ">
                                                        <input type="radio" value="no" id="no_radio"
                                                               name="marital_status" @if(count($client) > 0 && $client->marital_status == 'yes') checked @else checked @endif  class="md-radiobtn">
                                                        <label for="no_radio">
                                                            <span></span>
                                                            <span class="check"></span>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input class="form-control form-control-inline input-small date-picker"
                                                               ...
                                                               readonly @if(count($client) > 0 && isset($client->dob)) value="{{ $client->dob->format('m/d/Y') }}" @endif id="dob" name="dob"/>
                                                        <span class="help-block"> </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" id="anniversaryDiv">
                                                    <div class="form-group">
                                                        <input class="form-control form-control-inline input-small date-picker"
                                                               placeholder="Anniversary" size="16" type="text" @if(count($client) > 0 && isset($client->anniversary)) value="{{ $client->anniversary->format('m/d/Y') }}" @endif
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <input type="number" class="form-control" id="age" name="age" readonly @if(count($client) > 0 && isset($client->age)) value="{{ $client->age }}" @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <input type="email" class="form-control" id="email" name="email" @if(count($client) > 0 && isset($client->email)) value="{{ $client->email }}" @endif>
                                            <span class="help-block">Please enter clients email.</span>
                                            <label>Email <span class="required" aria-required="true"> * </span></label>
                                        </div>

                                        <div class="form-group form-md-line-input">
                                            <input type="tel" class="form-control" id="mobile" name="mobile" @if(count($client) > 0 && isset($client->mobile)) value="{{ $client->mobile }}" @endif>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            <textarea class="form-control" rows="3" name="address"
                                                      id="address">@if(count($client) > 0 && isset($client->address)) {{ $client->address }} @endif</textarea>
                                            <label>Address</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-md-line-input ">
                                                    <input type="number" class="form-control" id="height_feet"
                                                           name="height_feet" placeholder="feet" @if(count($client) > 0 && isset($client->height_feet)) value="{{ $client->height_feet }}" @endif>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-md-line-input ">
                                                    <input type="number" class="form-control" id="height_inches"
                                                           name="height_inches" placeholder="inches" @if(count($client) > 0 && isset($client->height_inches)) value="{{ $client->height_inches }}" @endif>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            <input type="number" class="form-control" id="weight" name="weight" @if(count($client) > 0 && isset($client->weight)) value="{{ $client->weight }}" @endif>
