    ...
    <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @if(count($payment) > 0 && isset($payment->id))
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <div class="input-group left-addon right-addon">
                                                ...
                                                <input type="number" min="0" class="form-control" name="payment_amount"
                                                       id="payment_amount" @if(count($payment) > 0 && isset($payment->payment_amount)) value="{{ $payment->payment_amount }}" @endif>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            <div class="form-group form-md-radios">
                                                ...
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input type="radio" value="cash" id="cash_radio" @if(count($payment) > 0 && $payment->payment_source == 'cash') checked @endif
                                                    ...
                                                    <div class="md-radio ">
                                                        <input type="radio" value="credit_card" id="credit_card_radio" @if(count($payment) > 0 && $payment->payment_source == 'credit_card') checked @endif
                                                               name="payment_source" class="md-radiobtn">
                                                    ...
                                                    <div class="md-radio">
                                                        <input type="radio" value="debit_card" id="debit_card_radio" @if(count($payment) > 0 && $payment->payment_source == 'debit_card') checked @endif
                                                               name="payment_source" class="md-radiobtn">
                                                    ...
                                                    <div class="md-radio">
                                                        <input type="radio" value="net_banking" id="net_banking_radio" @if(count($payment) > 0 && $payment->payment_source == 'net_banking') checked @endif
                                                               name="payment_source" class="md-radiobtn">
                                        ...
                                        <div class="form-group form-md-line-input ">
                                            <div class="input-group left-addon right-addon">
                                                ...
                                                <input type="text" class="form-control date-picker" readonly
                                                       name="payment_date"
                                                       value="@if(count($payment) > 0 && isset($payment->payment_date)) {{ $payment->payment_date->format('m/d/Y') }} @else {{ \Carbon\Carbon::now('Asia/Calcutta')->format('m/d/Y') }} @endif"
                                                       id="payment_date">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group form-md-line-input ">
                                                    <div class="input-icon">
                                                        <input type="text" class="form-control" placeholder="Remarks" @if(count($payment) > 0 && isset($payment->remark)) value="{{ $payment->remark }}" @endif
        ...
        @section('footer')
            ...
            <script>
                ...
                @if(count($payment) > 0 && isset($payment->user_id))
                    $(function() {
                        var amount = 0;
