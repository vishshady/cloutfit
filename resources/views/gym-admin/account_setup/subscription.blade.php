                ...
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @if(count($subscription) > 0 && isset($subscription->id))
                            ...
                            <div class="form-body">
                                ...
                                {{--<div class="form-group form-md-line-input">--}}
                                    {{--<select  class="bs-select form-control" data-live-search="true" data-size="8" name="payment_for" id="payment_for">--}}
                                        ...
                                        {{--<option @if(count($subscription) > 0) selected @endif value="membership">Membership</option>--}}
                                    {{--</select>--}}
                                        ...
                                        @foreach($memberships as $key => $membership)
                                            <optgroup label="{{$key}}">
                                                @foreach($membership as $mem)
                                                    <option @if(count($subscription) > 0 && $subscription->membership_id == $mem->id) selected @endif value="{{$mem->id}}">{{$mem->title}}</option>
                                                @endforeach
                                            </optgroup>
                                        @endforeach
                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group form-md-line-input ">
                                            <div class="input-group left-addon right-addon">
                                                ...
                                                <input type="number" class="form-control" name="purchase_amount" id="purchase_amount" @if(count($subscription) > 0 && isset($subscription->purchase_amount)) value="{{ $subscription->purchase_amount }}" @endif>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-md-line-input">
                                            <div class="input-group left-addon right-addon">
                                                <span class="input-group-addon"><i class="fa {{ $gymSettings->currency->symbol }}"></i></span>
                                                <input type="text" class="form-control" name="amount_to_be_paid" id="amount_to_be_paid" @if(count($subscription) > 0 && isset($subscription->amount_to_be_paid)) value="{{ $subscription->amount_to_be_paid }}" @endif>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <div class="input-group left-addon right-addon">
                                                <span class="input-group-addon"><i class="fa {{ $gymSettings->currency->symbol }}"></i></span>
                                                <input type="text" class="form-control" name="discount" id="discount" @if(count($subscription) > 0 && isset($subscription->discount)) value="{{ $subscription->discount }}" @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input ">
                                            <div class="input-icon">
                                                <input type="text" value="@if(count($subscription) > 0 && isset($subscription->purchase_date)) {{ $subscription->purchase_date->format('m/d/Y') }} @else {{ \Carbon\Carbon::today('Asia/Calcutta')->format('m/d/Y') }} @endif" class="form-control date-picker" placeholder="Select Purchase Date" name="purchase_date" readonly id="purchase_date">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <div class="input-icon">
                                                <input type="text" value="@if(count($subscription) > 0 && isset($subscription->start_date)) {{ $subscription->start_date->format('m/d/Y') }} @else {{ \Carbon\Carbon::today('Asia/Calcutta')->format('m/d/Y') }} @endif" class="form-control date-picker" readonly  name="start_date" id="start_date">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-md-line-input ">
                                            <div class="input-icon">
                                                <input type="text" class="form-control" placeholder="Remarks" name="remark" id="remark" @if(count($subscription) > 0 && isset($subscription->remark)) value="{{ $subscription->remark }}" @endif>
