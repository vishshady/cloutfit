                ...
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @if(count($memberships) > 0 && isset($memberships->id))
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="title" id="title" @if(count($memberships) > 0 && isset($memberships->title)) value="{{ $memberships->title }}" @endif>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group left-addon right-addon">
                                            ...
                                            <input type="number" class="form-control" name="price" id="price"  @if(count($memberships) > 0 && isset($memberships->price)) value="{{ $memberships->price }}" @endif>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6">
                                        <select class="bs-select form-control" data-live-search="true" data-size="8"  name="duration" id="duration">
                                            ...
                                            <option @if(count($memberships) > 0 && $memberships->duration == "7") selected @endif value="7">1 Week</option>
                                            <option @if(count($memberships) > 0 && $memberships->duration == "1") selected @endif value="1">1 Month</option>
                                            <option @if(count($memberships) > 0 && $memberships->duration == "3") selected @endif value="3">3 Months</option>
                                            <option @if(count($memberships) > 0 && $memberships->duration == "6") selected @endif value="6">6 Months</option>
                                            <option @if(count($memberships) > 0 && $memberships->duration == "12") selected @endif value="12">12 Months</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="details" id="details" rows="3">@if(count($memberships) > 0 && isset($memberships->details)) {{ $memberships->details }}  @endif</textarea>
